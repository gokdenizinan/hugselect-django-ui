...
def has_description(data):
    ...
    if not description or len(description.strip()) < 100: # too short
        return True
    elif len(set(description.split())) < 50:
...
lamer_models = download_filter(p4_download, 31, 4)
...
def has_downloads(data):
    ...
    if likes > 3:
        ...
        try:
            ...
            return True # Filter out old models with no likes
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            if problems == 0:
                ...
                if like > 50:
                    ...
                    top_10_fail[m_id] = p_count
                elif like > 0:
                    m_id = data.get("modelId", "")
                    top_all_fail[m_id] = p_count
...
with open("1-MODEL_FILTERING/N_top_10_fail.json", "w", encoding="utf-8") as f: # WILL BE REMOVED MODELS 
    json.dump(top_10_fail, f, indent=2, ensure_ascii=False)

with open("1-MODEL_FILTERING/N_top_all_fail.json", "w", encoding="utf-8") as f: # WILL BE REMOVED MODELS 
    json.dump(top_all_fail, f, indent=2, ensure_ascii=False)
