...
print(filter_counts_set)

unique_model_ids = {entry["model_id"] for entry in data.values() if "model_id" in entry}
count_unique = len(unique_model_ids)

# print("Unique model_ids:", unique_model_ids)
