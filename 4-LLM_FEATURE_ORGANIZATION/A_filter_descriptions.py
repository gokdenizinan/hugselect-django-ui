...
# # Load CSV
# df = pd.read_csv("4-LLM_FEATURE_ORGANIZATION/df_model_info.csv")  # adjust the path if needed
...
# plt.xscale('log')
# plt.xlabel("Number of Models Per Feature")
# plt.ylabel("Number of Features")
# # plt.title("Feature Frequency Across Models")
# # plt.grid(True, linestyle="--", alpha=0.5, which='both')
# plt.legend(title="Feature Frequency")
# plt.tight_layout()
# plt.savefig("N_feature_model_dist_scatter_seg.png")
# plt.show()
