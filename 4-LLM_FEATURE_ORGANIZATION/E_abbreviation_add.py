...
with open("4-LLM_FEATURE_ORGANIZATION/NP_info_global_suan.json", "r", encoding="utf-8") as f:
    dict_1 = json.load(f)

with open("4-LLM_FEATURE_ORGANIZATION/output_suan_A3.json", "r", encoding="utf-8") as f:
    dict_2 = json.load(f)
...
with open("4-LLM_FEATURE_ORGANIZATION/NP_info_global_suan_fin.json", "w", encoding="utf-8") as f:
