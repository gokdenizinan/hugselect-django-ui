    ...
    def _prepare_group_expansions(
        ...
        *,
        ...
        for value in include:
            ...
            existing_grams.extend(x for x in base_variants if _normalize_text(x) != _normalize_text(value))
            grams_by_value[value] = list(dict.fromkeys(existing_grams))
            ...
            for variant in base_variants:
                ...
                if norm_variant and norm_variant != _normalize_text(value) and norm_variant not in seen_syn_norms:
            ...
            syn_by_value[value] = existing_syns
