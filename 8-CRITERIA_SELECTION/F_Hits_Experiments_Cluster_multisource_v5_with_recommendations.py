...
recommendation_cols_order = [
    "recsys_recommendations",
...
recommendation_cols_existing = [c for c in recommendation_cols_order if c in compact_df.columns]
remaining_compact_cols = [
    c for c in compact_df.columns
    if c not in existing_compact_cols and c not in recommendation_cols_existing
]
compact_df = compact_df[existing_compact_cols + remaining_compact_cols + recommendation_cols_existing]
...
for col in recommendation_cols_order:
    if col in compact_df.columns:
