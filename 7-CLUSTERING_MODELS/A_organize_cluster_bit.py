...
df = pd.read_csv("7-CLUSTERING_MODELS/clusters_improved_2/family_assignments.csv")
...
cols =['model_id', 'model_name', 'assigned_domain', 'family_root',
       ...
       'base_model'
        ] #  "task",'pipeline_tag','effective_pipeline_tag', 'library_name', 'model_type', 'tags',
...
# Save to a new CSV
new_df.to_csv("7-CLUSTERING_MODELS/clusters_improved_2/family_assignments_organized.csv", index=False)
